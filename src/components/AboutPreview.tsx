...
export default function AboutPreview() {
  return (
    <section className="w-full py-32 bg-[#0ea5e9] relative z-10 overflow-hidden" id="about-us">
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10 flex flex-col items-end">
        ...
        <ScrollReveal animation="slide-up">
          <div className="w-full md:w-[80%] border-b-8 border-[#030014] pb-12 mb-12">
            <h2 className="font-heading font-black text-[#030014] text-[10vw] md:text-[8vw] leading-[0.8] tracking-tighter uppercase">
              EST. 2008. <br/>
              <span className="text-white drop-shadow-[4px_4px_0_#030014]">AUTHORISED</span> <br/>
              GLOBAL <br/>
        ...
        <div className="w-full flex flex-col xl:flex-row gap-16 md:gap-32 justify-end">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-12">
            <ScrollReveal animation="fade">
              <p className="font-mono text-[#030014] text-xl leading-relaxed font-bold border-l-4 border-white pl-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <ScrollReveal animation="slide-up" delay={0.1}>
                <div className="bg-[#030014] text-white p-8 transform -rotate-1 hover:rotate-0 transition-transform shadow-2xl h-full">
                  <Factory className="w-12 h-12 text-[#0284c7] mb-4" />
              ...
              <ScrollReveal animation="slide-up" delay={0.2}>
                <div className="bg-white text-[#030014] p-8 transform rotate-1 hover:rotate-0 transition-transform shadow-2xl h-full">
                  <Target className="w-12 h-12 text-[#0ea5e9] mb-4" />
              ...
              <ScrollReveal animation="slide-up" delay={0.3}>
                <div className="bg-white text-[#030014] p-8 transform -rotate-1 hover:rotate-0 transition-transform shadow-2xl h-full">
                  <Wrench className="w-12 h-12 text-[#0ea5e9] mb-4" />
              ...
              <ScrollReveal animation="slide-up" delay={0.4}>
                <div className="bg-[#030014] text-white p-8 transform rotate-1 hover:rotate-0 transition-transform shadow-2xl h-full">
                  <Award className="w-12 h-12 text-[#0284c7] mb-4" />
          ...
          {/* Right / Bottom Visual */}
          <ScrollReveal animation="slide-left" className="w-full xl:w-1/2 relative h-[500px] md:h-auto min-h-[600px] border-4 border-[#030014] bg-[#030014] overflow-hidden group">
             <Image 
             ...
             />
             <div className="absolute inset-0 border-[20px] border-[#0ea5e9] m-8 mix-blend-overlay pointer-events-none" />
             <div className="absolute bottom-0 left-0 bg-[#030014] text-white font-heading font-black text-4xl p-6 uppercase tracking-widest">
                Trusted Excellence
             </div>
          </ScrollReveal>
