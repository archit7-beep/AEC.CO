    ...
    <>
      ...
      >
        ...
        <section className="relative w-full pt-32 pb-8 px-6 md:px-12 lg:px-20 text-center flex flex-col items-center">
          ...
          >
            <h1 className="font-black text-5xl md:text-7xl leading-tight tracking-tighter text-white mb-6">
              Industrial Power.<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400">
                Intelligent Control.
              </span>
            </h1>
            <p className="text-slate-400 text-lg md:text-xl leading-relaxed max-w-2xl font-body">
        ...
        <section className="relative w-full py-24 px-6 md:px-12 lg:px-20 border-t border-white/5 bg-[#030014]/50">
          <div className="max-w-[1000px] mx-auto text-center flex flex-col items-center">
            <Shield className="w-12 h-12 text-cyan-500/50 mb-8" />
            <h2 className="font-sans font-bold text-3xl md:text-5xl text-white tracking-tight mb-8">
              Why Choose Our Matrix Architecture?
            </h2>
            <div className="text-slate-400 text-base md:text-lg leading-relaxed max-w-3xl flex flex-col gap-6 font-body">
              <p>
            ...
            <div className="mt-12 flex items-center justify-center gap-6">
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-bold tracking-wide hover:bg-white/10 hover:border-white/30 transition-all duration-300"
              >
