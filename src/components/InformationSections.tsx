...
export function IndustriesServed() {
  return (
    <section className="w-full py-16 md:py-32 relative z-10 bg-[#0A192F] overflow-hidden" id="industries">
      {/* Background blueprint elements */}
      <div className="absolute inset-0 blueprint-grid opacity-30 pointer-events-none" />
      <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-[#00A8CC]/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        <ScrollReveal animation="slide-up">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 md:mb-16 border-b border-white/10 pb-12">
            <div>
              <h4 className="font-mono text-[#00A8CC] font-bold tracking-[0.2em] uppercase mb-4 border-l-4 border-[#00A8CC] pl-4">Global Reach</h4>
              <h2 className="font-heading font-black text-5xl lg:text-7xl text-white uppercase tracking-tighter leading-none">
                Sectors We <br/> <span className="text-[#FBCC13]">Empower</span>
              </h2>
            </div>
          ...
          {INDUSTRIES.map((ind, idx) => {
            ...
            return (
              <ScrollReveal key={idx} animation="scale" delay={idx * 0.1} className={ind.colSpan}>
                <div 
                  className={`relative bg-[#112240] border border-white/5 hover:border-[#FBCC13] rounded-sm p-8 flex flex-col items-center justify-center text-center group transition-all duration-700 overflow-hidden cursor-crosshair h-full w-full`}
                >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#0A192F] via-transparent to-[#FBCC13]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-0" />
                
                {/* Giant faint icon in background */}
                <Icon className="absolute -right-4 -bottom-4 w-32 h-32 text-white opacity-[0.02] group-hover:scale-150 group-hover:-rotate-12 group-hover:opacity-[0.15] group-hover:text-[#FBCC13] transition-all duration-700 z-0" />
                
                <div className="relative z-10 transform group-hover:-translate-y-2 transition-transform duration-500">
                  <div className="w-16 h-16 rounded-full bg-[#0A192F] border-2 border-[#00A8CC] flex items-center justify-center mb-4 group-hover:bg-[#0A192F]/80 group-hover:border-[#FBCC13] group-hover:backdrop-blur-md transition-all duration-500 mx-auto shadow-[0_0_20px_rgba(0,168,204,0.2)] group-hover:shadow-[0_0_40px_rgba(251,204,19,0.5)]">
                    <Icon className="w-8 h-8 text-[#00A8CC] group-hover:text-[#FBCC13] transition-colors duration-500" />
                  </div>
                ...
                <div className="absolute top-2 left-2 w-2 h-2 border-t border-l border-[#00A8CC]/50 group-hover:border-[#FBCC13] group-hover:scale-150 transition-all duration-500 z-10" />
                <div className="absolute top-2 right-2 w-2 h-2 border-t border-r border-[#00A8CC]/50 group-hover:border-[#FBCC13] group-hover:scale-150 transition-all duration-500 z-10" />
                <div className="absolute bottom-2 left-2 w-2 h-2 border-b border-l border-[#00A8CC]/50 group-hover:border-[#FBCC13] group-hover:scale-150 transition-all duration-500 z-10" />
                <div className="absolute bottom-2 right-2 w-2 h-2 border-b border-r border-[#00A8CC]/50 group-hover:border-[#FBCC13] group-hover:scale-150 transition-all duration-500 z-10" />
                </div>
              </ScrollReveal>
            );
          })}
...
export function OurServices() {
  return (
    <section className="w-full py-16 md:py-24 relative z-10 overflow-hidden bg-[#112240]" id="services">
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative">
        <ScrollReveal animation="fade">
          <div className="text-center mb-12 md:mb-20 relative z-20 flex flex-col items-center">
            <div className="bg-[#FBCC13] text-[#0A192F] font-mono font-bold px-4 py-2 uppercase tracking-[0.3em] -rotate-2 inline-block shadow-lg">
              Core Expertise
            </div>
            <h2 className="font-heading font-black text-5xl md:text-[5rem] text-white mt-6 md:mt-8 leading-none tracking-tighter uppercase drop-shadow-xl">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00A8CC] to-[#005A7A] italic pr-4">Services</span>
            </h2>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <ScrollReveal animation="slide-up" delay={0.1}>
            <div className="bg-[#0A192F] border-2 border-white/10 rounded-2xl group hover:border-[#FBCC13] transition-colors duration-500 overflow-hidden relative">
              <div className="h-64 relative overflow-hidden">
                 ...
                 <Factory className="absolute bottom-6 left-6 w-12 h-12 text-[#FBCC13]" />
              </div>
          ...
          <ScrollReveal animation="slide-up" delay={0.2}>
            <div className="bg-[#0A192F] border-2 border-white/10 rounded-2xl group hover:border-[#00A8CC] transition-colors duration-500 overflow-hidden relative">
              <div className="h-64 relative overflow-hidden">
                 ...
                 <div className="absolute inset-0 bg-gradient-to-t from-[#0A192F] to-transparent" />
                 <Box className="absolute bottom-6 left-6 w-12 h-12 text-[#00A8CC]" />
              </div>
              <div className="p-8 pt-0 mt-4">
          ...
          <ScrollReveal animation="slide-up" delay={0.3}>
            <div className="bg-[#0A192F] border-2 border-white/10 rounded-2xl group hover:border-white transition-colors duration-500 overflow-hidden relative">
              <div className="h-64 relative overflow-hidden">
...
export function WhyChooseUs() {
  return (
    <section className="w-full py-16 md:py-20 bg-[#FBCC13] relative z-10 overflow-hidden border-y-8 border-[#0A192F]">
      
      {/* Massive Background Text */}
      <div className="absolute top-[5%] left-[-5%] w-[110%] pointer-events-none opacity-20 flex whitespace-nowrap z-0">
        <h2 className="text-[20vw] font-heading font-black text-[#0A192F] leading-none tracking-tighter">
          ADVANTAGE ADVANTAGE
        </h2>
      </div>
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 md:gap-20">
          ...
          <ScrollReveal animation="slide-right" className="w-full lg:w-1/3 flex flex-col gap-6 mt-8 md:mt-12">
            <div className="bg-[#0A192F] text-white px-6 py-2 uppercase tracking-[0.3em] font-mono font-bold w-fit shadow-[8px_8px_0_rgba(255,255,255,0.3)] transform -rotate-2 rounded-lg">
              The AEC Advantage
            </div>
            <h2 className="font-heading font-black text-5xl md:text-7xl text-[#0A192F] uppercase leading-[0.85] tracking-tighter drop-shadow-lg mt-2">
              WHY <br/> CHOOSE <br/> <span className="text-white drop-shadow-[4px_4px_0_#0A192F]">AEC?</span>
            </h2>
            <p className="font-mono text-[#0A192F] font-bold text-lg leading-relaxed border-l-4 border-white pl-6 mt-4">
            ...
            <Link href="/products" className="bg-[#0A192F] text-white font-heading font-black uppercase tracking-widest text-xl px-12 py-6 w-fit shadow-[8px_8px_0_rgba(255,255,255,0.8)] hover:translate-y-1 hover:shadow-[4px_4px_0_rgba(255,255,255,0.8)] transition-all mt-8 rounded-xl inline-block">
              View Catalog
            </Link>
          </ScrollReveal>
            ...
            {FEATURES.map((feat, idx) => {
              ...
              return (
                <ScrollReveal key={idx} animation="slide-up" delay={0.1 * idx}>
                  <div className="bg-[#0A192F] p-6 border-4 border-white transform hover:-translate-y-2 transition-transform duration-300 group shadow-xl relative overflow-hidden rounded-2xl h-full">
                    <div className="absolute -right-10 -bottom-10 opacity-10 group-hover:scale-150 transition-transform duration-700">
                      <Icon className="w-32 h-32 text-white" />
                    </div>
                    <div className="relative z-10">
                      <Icon className="w-10 h-10 text-[#FBCC13] mb-4" />
