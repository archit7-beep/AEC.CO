...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[120vh] bg-[#030014] overflow-hidden flex flex-col items-center justify-center pt-20" id="home">
      ...
      <div className="max-w-[1800px] w-full mx-auto px-6 md:px-12 relative z-10 h-full flex flex-col justify-center">
        ...
        <div className="absolute top-[5%] md:top-[10%] left-[5%] md:left-[10%] z-50 w-32 h-32 md:w-48 md:h-48 flex items-center justify-center opacity-90 -rotate-12 hover:rotate-0 transition-transform duration-500 shadow-[0_0_30px_rgba(212,175,55,0.15)] rounded-full">
          {/* Outer Stamp Edge */}
          <div className="absolute inset-0 rounded-full border-[3px] border-dashed border-[#0ea5e9] opacity-80" />
          {/* Inner Rings */}
          <div className="absolute inset-1.5 rounded-full border-2 border-[#0ea5e9]" />
          <div className="absolute inset-[22%] rounded-full border border-[#0ea5e9] opacity-50" />
          ...
          <svg viewBox="0 0 200 200" className="absolute inset-0 w-full h-full">
            ...
            <text fontSize="14" fontWeight="bold" fill="#0ea5e9" letterSpacing="2" className="uppercase font-mono">
              <textPath href="#curveTop" startOffset="50%" textAnchor="middle" dominantBaseline="central">
                ★ AUTHORIZED DISTRIBUTOR ★
              </textPath>
            </text>
            <text fontSize="14" fontWeight="bold" fill="#0ea5e9" letterSpacing="4" className="uppercase font-mono">
          ...
          {/* Center Graphic */}
          <div className="relative z-10 flex flex-col items-center justify-center text-[#0ea5e9]">
            <span className="text-xl md:text-3xl leading-none font-serif mb-0.5">★</span>
            <span className="text-[10px] md:text-xs font-black tracking-widest border-t-2 border-b-2 border-[#0ea5e9] mt-0.5 px-2">AMAL</span>
          </div>
        </div>
        ...
        <div className="relative z-20 text-center flex flex-col items-center mt-40 md:mt-10">
          ...
          <ScrollReveal animation="scale" delay={0.2} className="relative z-30 flex items-center justify-center w-full max-w-[600px] h-[200px] md:h-[300px] my-4 md:my-0 group">
            ...
            <div className="relative w-40 h-40 md:w-56 md:h-56 rounded-full border-4 border-[#0ea5e9] flex items-center justify-center animate-[spin_30s_linear_infinite] shadow-[0_0_50px_rgba(251,204,19,0.3)] bg-[#030014] overflow-hidden p-2">
               <Image 
               ...
               <div className="absolute inset-2 border-2 border-dashed border-[#0284c7] rounded-full opacity-50" />
            </div>
            
            {/* Floating Tags bound to Center Area */}
            <div className="absolute top-[10%] -left-[5%] md:-left-[10%] z-30 bg-[#0284c7] text-[#030014] font-mono font-bold text-xs md:text-sm px-6 py-2 uppercase tracking-widest -rotate-6 shadow-xl transform hover:scale-110 transition-transform">
              Industrial Core
            </div>
            <div className="absolute bottom-[10%] -right-[5%] md:-right-[10%] z-30 bg-[#0ea5e9] text-[#030014] font-mono font-bold text-xs md:text-sm px-6 py-2 uppercase tracking-widest rotate-3 shadow-xl transform hover:scale-110 transition-transform">
              Precision Output
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal animation="slide-up" delay={0.1}>
            <div className="overflow-hidden mt-[-3rem] md:mt-[-6rem] z-10 relative">
              <h1 className="text-[20vw] md:text-[18vw] font-heading font-black text-[#030014] leading-[0.75] tracking-tighter uppercase drop-shadow-md" style={{ WebkitTextStroke: '2px #0ea5e9' }}>
                ENGG
              </h1>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade" delay={0.4}>
            <div className="mt-12 md:mt-16 z-40 relative">
              <Link href="/products" className="relative overflow-hidden group bg-[#0ea5e9] border-2 border-[#0ea5e9] text-[#030014] font-heading font-black text-2xl md:text-3xl px-16 py-6 transition-all duration-300 shadow-[8px_8px_0_white] hover:translate-y-1 hover:shadow-[4px_4px_0_white] hover:bg-white inline-block">
        ...
        <div className="absolute top-[50%] left-[5%] w-[25vw] md:w-[15vw] aspect-square z-10 rounded-full overflow-hidden border-2 border-[#0ea5e9] transform -rotate-6 hover:rotate-0 hover:scale-105 transition-all duration-500 hidden md:block">
          <Image src="/booklet/hero_compressor.png" alt="Compressor" fill className="object-cover bg-white" />
        </div>
        <div className="absolute top-[25%] right-[5%] w-[25vw] md:w-[15vw] aspect-square z-10 rounded-full overflow-hidden border-2 border-[#0ea5e9]/50 shadow-[0_0_15px_rgba(251,204,19,0.3)] transform rotate-12 hover:rotate-0 hover:scale-105 hover:shadow-[0_0_40px_rgba(251,204,19,0.8)] transition-all duration-500 hidden md:block">
          <Image src="/vs_products/product_12.png" alt="Pneumatics" fill className="object-cover opacity-60 hover:opacity-100 transition-opacity bg-[#110b29] p-6" />
        </div>
        ...
        <ScrollReveal animation="fade" delay={0.6}>
          <div className="mt-24 md:mt-16 mb-20 md:mb-32 w-full flex flex-col md:flex-row items-center justify-center z-40 relative">
            <p className="font-mono text-xs md:text-sm text-[#0284c7] tracking-[0.2em] max-w-2xl text-center border-t-2 border-[#0284c7] pt-4 uppercase drop-shadow-xl bg-[#030014]/80 px-4 py-2 rounded">
      ...
      <div className="absolute bottom-0 w-full leading-[0] z-50">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" className="w-full h-auto fill-[#030014] md:fill-transparent">
